...
import {getDoctorsWhoPerformedSameProceduresAsDoctorX, getTotalCostForPatientX, getVisitsOfPatientXToDoctorWithSpecializationY } from "../../api";
...
const QueryForm7 = () => {
  ...
  const onSubmit = async (values, actions) => {
    try {
      ...
      const res = await getDoctorsWhoPerformedSameProceduresAsDoctorX(`?doctorID=${values.doctorID}`);
